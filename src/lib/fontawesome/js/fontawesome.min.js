...
!(function () {
	...
	var T = R(
		...
		D = R((s((f = {}), I, { solid: "fas", regular: "far", light: "fal", thin: "fat", duotone: "fad", brands: "fab", kit: "fak" }), s(f, L, { solid: "fass" }), f)),
		F = R((s((u = {}), I, { fab: "fa-brands", fad: "fa-duotone", fak: "fa-kit", fal: "fa-light", far: "fa-regular", fas: "fa-solid", fat: "fa-thin" }), s(u, L, { fass: "fa-solid" }), u)),
		H = R(
	...
	function Zt(t) {
		...
		d && (b.attributes[O] = ""),
			c && (b.children.push({ tag: "title", attributes: { id: b.attributes["aria-labelledby"] || "title-".concat(l || at()) }, children: [c] }), delete b.attributes.title)
		var v,
			p,
			g,
			h,
			...
			s
				...
				: ((g = (p = t).children),
				  ...
				  ot((p = p.transform)) &&
						y.found &&
						!v.found &&
						((v = y.width / y.height / 2), (y = 0.5), (h.style = rt(k(k({}, t), {}, { "transform-origin": "".concat(v + p.x / 16, "em ").concat(y + p.y / 16, "em") })))),
		...
		replace: function (t) {
			...
			a.parentNode &&
				...
				null === a.getAttribute(O) && J.keepOriginalSource
					? ((t = h.createComment(((t = " ".concat((t = a).outerHTML, " ")), (t = "".concat(t, "Font Awesome fontawesome.com "))))), a.parentNode.replaceChild(t, a))
					: a.remove())
		},
		nest: function (t) {
			var a = t[0],
			...
			u && "none" !== d && "" !== d
				? ((s = l.getPropertyValue("content")),
				  ...
				  l &&
						((d = jt[(l = d)]),
						(l = Lt("fas", l)),
						(l = d || (l ? { prefix: "fas", iconName: l } : null) || { prefix: null, iconName: null }).iconName && l.prefix && ((u = l.iconName), (n = l.prefix))),
				...
				provides: function (t) {
					t.generateAbstractTransformGrouping = function (t) {
						...
						return {
							...
							children: [{ tag: "g", attributes: k({}, i.inner), children: [{ tag: a.icon.tag, children: a.icon.children, attributes: k(k({}, a.icon.attributes), i.path) }] }]
						}
					}
				}
			},
			{
				...
				provides: function (t) {
					t.generateAbstractMask = function (t) {
						...
						return (
							a.push(o, { tag: "rect", attributes: k({ fill: "currentColor", "clip-path": "url(#".concat(r, ")"), mask: "url(#".concat(f, ")") }, Ta) }), { children: a, attributes: e }
						)
					}
				}
			},
