...
!(function () {
	...
	var i = n((H((v = {}), f, { solid: "fas", regular: "far", light: "fal", thin: "fat", duotone: "fad", brands: "fab", kit: "fak" }), H(v, h, { solid: "fass" }), v)),
		V =
			(n((H((z = {}), f, { fab: "fa-brands", fad: "fa-duotone", fak: "fa-kit", fal: "fa-light", far: "fa-regular", fas: "fa-solid", fat: "fa-thin" }), H(z, h, { fass: "fa-solid" }), z)),
			n(
				(H((C = {}), f, { "fa-brands": "fab", "fa-duotone": "fad", "fa-kit": "fak", "fa-light": "fal", "fa-regular": "far", "fa-solid": "fas", "fa-thin": "fat" }),
				H(C, h, { "fa-solid": "fass" }),
				C)
			),
			n((H((c = {}), f, { 900: "fas", 400: "far", normal: "far", 300: "fal", 100: "fat" }), H(c, h, { 900: "fass" }), c)),
	...
	function S(C, c, z) {
		var M = (2 < arguments.length && void 0 !== z ? z : {}).skipHooks,
			z = void 0 !== M && M,
			M = u(c)
		"function" != typeof d.hooks.addPack || z ? (d.styles[C] = l(l({}, d.styles[C] || {}), M)) : d.hooks.addPack(C, u(c)), "fas" === C && S("fa", c)
	}
	var g = {
		"trash-can": [
			448,
